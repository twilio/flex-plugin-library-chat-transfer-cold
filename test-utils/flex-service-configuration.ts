...
import { UIAttributes } from '../ui-src/src/types/manager/ServiceConfiguration';
import FeatureServiceConfiguration from '../ui-src/src/types/manager/CustomServiceConfiguration'
...
let mockedServiceConfiguration: ServiceConfiguration = {
  ...
  ui_attributes: {
    custom_data: {
      serverless_functions_protocol: 'mockFunctionsProtocol',
      serverless_functions_domain: 'mockFunctionsDommain',
      serverless_functions_port: 'mockFunctionsPort',
      features: {} as FeatureServiceConfiguration
    }
  },
...
export const resetServiceConfiguration = () => {
  mockedServiceConfiguration = { account_sid: 'mockAccountSid',
  attributes: {},
  call_recording_enabled: false,
  chat_service_instance_sid: 'mockChatServiceInstanceSid',
  crm_attributes: null,
